  ...
  describe('QAStoreActions interface', () => {
    it('should define all action signatures', () => {
      ...
      const mockActions: QAStoreActions = {
        ...
        startSession: async (_taskId: string, _projectId: string) => {},
        updateAnswer: (_questionId: string, _answer: string) => {},
        completeSession: async () => {},
        loadSession: async (_sessionId: string) => {},
        selectCategory: (_categoryId: string | null) => {},
        getQuestionsByCategory: (_categoryId: string) => [],
        calculateProgress: () => 0,
        openModal: () => {},
        closeModal: () => {},
        clearError: () => {},
