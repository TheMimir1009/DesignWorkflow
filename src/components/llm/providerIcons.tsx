 ...
 * Visual icons for different LLM providers
 *
...
export interface ProviderIconProps {
  /** The provider to display icon for */
...
/**
 * Provider-specific color mapping for badges
 */
...
export function ProviderIcon({ provider, className = '' }: ProviderIconProps) {
  const baseClassName = 'w-3 h-3 flex-shrink-0';
